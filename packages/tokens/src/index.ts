...
/**
 * Get CSS variables for specific theme
 */
const _getColorCSSVarsForTheme = (theme: 'light' | 'dark') => {
  const colors = theme === 'dark' ? darkSemanticColors : semanticColors

  return {
    '--brand-primary': colors.brand.primary,
    '--brand-primary-hover': colors.brand.primaryHover || colors.brand.primary,
    '--brand-primary-active': colors.brand.primaryActive || colors.brand.primaryHover,
    '--brand-secondary': colors.brand.secondary,
    '--brand-secondary-hover': colors.brand.secondaryHover || colors.brand.secondary,
    '--brand-secondary-active': colors.brand.secondaryActive || colors.brand.secondaryHover,
    ...
    '--bg-ghost-hover': colors.background.ghostHover || '#f0f9ff',
    '--bg-ghost-active': colors.background.ghostActive || '#e0f2fe',
    '--bg-filled': colors.background.filled || '#fafafa',
    '--bg-filled-hover': colors.background.filledHover || '#f5f5f5',
    '--bg-disabled': colors.background.disabled || '#fafafa',
    '--border-default': colors.border.default,
    '--border-hover': colors.border.hover || '#a3a3a3',
    '--border-focus': colors.border.focus,
    '--color-success': colors.success,
    '--color-success-hover': colors.successHover || '#16a34a',
    '--color-error': colors.error,
    '--color-error-hover': colors.errorHover || '#dc2626',
    '--color-warning': colors.warning,
    '--color-warning-hover': colors.warningHover || '#d97706',
    '--color-info': colors.info,
    '--focus-ring': colors.focusRing || 'rgba(14, 165, 233, 0.1)',
    '--success-focus-ring': colors.successFocusRing || 'rgba(34, 197, 94, 0.1)',
    '--error-focus-ring': colors.errorFocusRing || 'rgba(239, 68, 68, 0.1)',
  }
}
