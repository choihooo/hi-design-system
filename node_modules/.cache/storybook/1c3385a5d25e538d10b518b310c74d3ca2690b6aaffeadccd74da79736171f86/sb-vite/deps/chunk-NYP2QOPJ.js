import {
  ...
  __export,
  __toESM as __toESM2
} from "./chunk-WZLD2R4O.js";
import {
  require_react
} from "./chunk-TQW65MCD.js";
import {
  require_global
...
// node_modules/.pnpm/@storybook+react@8.6.14_react-dom@18.3.1_react@18.2.0_storybook@8.6.14_typescript@5.9.3/node_modules/@storybook/react/dist/chunk-TENYCC3B.mjs
...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-MIN4O76V.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-UIFFZYIK.js"), act = await getAct();
...
//# sourceMappingURL=chunk-NYP2QOPJ.js.map
